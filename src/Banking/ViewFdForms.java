 ...
 * @author Stark
 */
public class ViewFdForms extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("View Fixed Deposit");
        ...
        jtabl_Show.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "FD Number", "Account Number", "Mode", "Amount", "Period", "Interest", "Date"
            }
        ));
    ...
    private void jcmb_AccnoPopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_jcmb_AccnoPopupMenuWillBecomeInvisible
       try{ reset();
        ...
        String sele="select * from fixeddeposit where AccountNumber='"+Accno+"'";
        ...
        try {
            ...
            {
                JOptionPane.showMessageDialog(null, "No FD's were Found for this account.", "Error", JOptionPane.ERROR_MESSAGE);
            }
    ...
    private void btn_ShowAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ShowAllActionPerformed
        reset();
        Date=df.format(d);
        String sele="select * from fixeddeposit";
        rs=conMe.getConnection(sele);
        try {
            if (rs.next())
            {
            ...
            {
                JOptionPane.showMessageDialog(null, "No FD's were Found.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        } catch (SQLException ex) {
            Logger.getLogger(Deposit.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btn_ShowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ShowActionPerformed
        ...
        {
            Date=df.format(d);
            String sele="select * from fixeddeposit where Date='"+Date+"'";
            rs=conMe.getConnection(sele);
            try {
                if (rs.next())
                {
                ...
                {
                    JOptionPane.showMessageDialog(null, "No FD's were Found on this date.", "Error", JOptionPane.ERROR_MESSAGE);
                }
            } catch (SQLException ex) {
                Logger.getLogger(Deposit.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewFdForms.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewFdForms().setVisible(true);
            }
        });
    }
